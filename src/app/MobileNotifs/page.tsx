...
import { IPendingFriends, IUserDataWithRequestId, IPendingMembers } from '@/Interfaces/Interfaces';
...
const MobileNotifs = () => {
  ...
  return (
    <div className='h-full bg-offwhite bg-no-repeat bg-cover'>
        <NavbarComponent/>
