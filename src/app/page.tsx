    ...
    <div className="flex">
      ...
      <div className={logsign ? "flex flex-col flex-1 mt-44 font-mainFont" : "flex flex-col flex-1 pt-5 font-mainFont"}>
        ...
        <div className="p-20 w-11/12">
          ...
          <button className={logsign ? "bg-signHeader p-3 text-white pl-24 pr-24 rounded-3xl font-thin mt-10" : "bg-signUpBtn p-3 text-white pl-24 pr-24 rounded-3xl font-thin mt-10 mb-3" }>{logsign ? "Sign in" : "Sign up"}</button>
